      ...
      createUserWithEmailAndPassword(
        ...
        .then((userCredential) => {
          ...
          updateProfile(user, {
            ...
            photoURL:
              "https://avatars.githubusercontent.com/u/163979318?s=400&u=ae9837ff861da06b5dbfe72a97e194d349d40238&v=4",
          })
            .then(() => {
  ...
  return (
    <div>
      ...
      >
        ...
        <button
          className="p-2 mx-2 my-4 bg-red-700 w-full rounded-lg"
