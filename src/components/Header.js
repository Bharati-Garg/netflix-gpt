...
//           {showGptSearch && (
//             <select
//               className="px-4 m-4 bg-gray-900 text-white "
...
//           <button
//             className=" px-4 m-4 bg-purple-800 text-white rounded-lg"
...
//           <img
//             className="rounded-lg w-8 h-8 m-4"
//             src={USER_AVATAR}
//             alt="userIcon"
//           />
...
//             className="font-bold text-white bg-red-800 px-4 m-4 rounded-lg"
//           >
//             Sign Out
//           </button>
//         </div>
...
//         </button>
//         <img
//           className="hidden md:block w-8 h-8 my-4 mx-2"
//           src={user?.photoURL}
//           alt="usericon"
//         />
//         <button
